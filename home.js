...
<p><span>Top Boat</span>${detailLink("/boat-detail/", "boat", r.top_boat_today)}</p>
<p><span>Landing</span>${detailLink("/landing-detail/", "landing", r.top_landing_today)}</p>
<p><span>Hot Species</span>${detailLink("/species-detail/", "species", r.top_species_today)}</p>
      </div>
    </article>
  `).join("");
}
